...
function Hero() {
  return (
    <section className="relative h-full bg-gradient-to-br from-sky-100 via-white to-sky-100 pl-2 pr-2 text-gray-800 flex items-center flex-col">
        ...
        <div className="mx-auto max-w-5xl text-center">
          <h1 className="text-3xl font-extrabold sm:text-5xl p-3">
            ...
            <strong className="font-extrabold text-primary sm:block p-3">
              {" "}
              <span className="text-gray-900">using</span> ExpensePilot.{" "}
            </strong>
          </h1>

          <p className="mt-0 sm:text-xl/relaxed">
            From budgeting to tracking, we’re your co-pilot for a smoother
            financial journey. Sign up and take charge of your expenses now!
          </p>
...
<div>
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    Get to the root of your finances with ExpensePilot. Understand your spending habits, create better budgets, and nurture your financial growth. Start tracking your way to success now.
    </p>
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      ...
      <li>
        <a
          ...
          rel="noreferrer"
          target="_blank"
          className= "hover:text-gray-700/75"
        >
